...
const cleaningCatalog = [
  ...
  { room: 'Schlafzimmer', tasks: ['Bett machen', 'Bettwäsche wechseln', 'Matratze absaugen', 'Nachttische abwischen', 'Schränke abstauben', 'Kleidung in den Schrank einräumen', 'Saubere Wäsche verteilen', 'Schmutzwäsche einsammeln', 'Boden saugen', 'Boden wischen', 'Fenster putzen'] },
  { room: 'Kinderzimmer', tasks: ['Spielzeug in Kisten einräumen', 'Bücher ins Regal einräumen', 'Schreibtisch aufräumen', 'Schulranzen ausräumen', 'Oberflächen abwischen', 'Regale entstauben', 'Bettwäsche wechseln', 'Kleidung in den Schrank einräumen', 'Schmutzwäsche einsammeln', 'Boden saugen', 'Boden wischen', 'Fenster putzen'] },
  ...
  { room: 'Hauswirtschaftsraum', tasks: ['Wäsche sortieren', 'Waschmaschine einräumen', 'Waschmaschine starten', 'Waschmaschine ausräumen', 'Wäsche aufhängen', 'Wäsche abnehmen', 'Trockner einräumen', 'Trockner starten', 'Trockner ausräumen', 'Wäsche zusammenlegen', 'Wäsche bügeln', 'Saubere Wäsche in Schränke einräumen', 'Waschmaschine reinigen', 'Trockner reinigen', 'Flusensieb säubern', 'Wäschekörbe leeren', 'Regale aufräumen', 'Vorräte einräumen', 'Vorräte prüfen', 'Boden saugen', 'Boden wischen'] },
  ...
  { room: 'Gesamtes Zuhause', tasks: ['Einkäufe einräumen', 'Getränkekisten einräumen', 'Leergut zusammenstellen', 'Altpapier sammeln', 'Pfand wegbringen', 'Mülltonnen rausstellen', 'Mülltonnen zurückstellen', 'Alle Räume lüften', 'Staub wischen', 'Türgriffe reinigen', 'Lichtschalter reinigen', 'Heizkörper entstauben', 'Sockelleisten reinigen', 'Spinnweben entfernen', 'Fenster putzen', 'Staubsaugen', 'Böden wischen', 'Mülleimer leeren', 'Putzmittel auffüllen'] },
] as const;
