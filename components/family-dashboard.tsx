...
export function FamilyDashboard() {
  ...
  return <div className="min-h-screen bg-background text-foreground"><div className="app-shell">
    <aside className={`sidebar ${menuOpen ? 'sidebar-open' : ''}`}>
      <div className="brand"><img className="brand-logo" src="/family-base-logo.png" alt="Family Base" /><button className="mobile-close" onClick={() => setMenuOpen(false)} aria-label="Menü schließen"><X /></button></div>
